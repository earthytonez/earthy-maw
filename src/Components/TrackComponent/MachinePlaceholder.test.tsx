...
test('renders learn react link', () => {
    const machineType: "sequencer"| "modulator"| "synthesizer"| "arranger"| "musicFeature" | undefined = "sequencer"


    const uiStateStore = new UIStateStore();
    const container = shallow(<MachinePlaceholder placeholder="placeholder" machineType={machineType} />);
